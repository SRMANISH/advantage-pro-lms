...
DeviceManageRoles = has_any_role(Role.SUPER_ADMIN, Role.ADMIN, Role.MIS, Role.FACULTY)
...
class DeviceRequestDecideView(APIView):
    ...
    def post(self, request, pk=None):
        ...
        if decision == "approve":
            device.approve_request(req, request.user)
        elif decision == "reject":
            device.reject_request(req, request.user)
        else:
